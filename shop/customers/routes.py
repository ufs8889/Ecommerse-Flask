...
from shop.details import db, app, photos
from shop.details import bcrypt
from shop.customers.forms import CustomerRegistrationForm, CustomerLoginForm
from .models import RegisterModel
import secrets, os
from shop.details import login_manager
